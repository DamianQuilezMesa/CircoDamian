...
public class BuscarEspectaculoController implements Initializable {
    ...
    @FXML private Label lblId, lblNombre, lblPeriodo, lblCoordinador, lblSenior, lblSinSeleccion;
    @FXML private VBox panelCompleto;
    ...
    @FXML private void mostrarAyuda(ActionEvent e) {
        ...
        a.setHeaderText("Consultar información completa de un espectáculo");
        a.setContentText(
            "Selecciona un espectáculo del desplegable.\n\n" +
            "Se mostrará: ID, nombre, periodo, coordinador,\n" +
            "números (con orden y duración) y artistas de cada número."
        );
        a.showAndWait();
    }
