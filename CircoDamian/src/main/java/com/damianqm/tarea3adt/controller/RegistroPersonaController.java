...
public class RegistroPersonaController implements Initializable {
	...
	@FXML
	private RadioButton rbCoordinacion;
	@FXML
	...
	@FXML
	private CampoPassword cpPassword;
	...
	private void registrarArtista() {
		...
		personaService.registrarArtista(txtNombre.getText().trim(), txtEmail.getText().trim(),
				obtenerCodigoNacionalidad(), apodo.isEmpty() ? null : apodo, especialidades,
				txtUsuario.getText().trim(), cpPassword.getText());
	...
	private void registrarCoordinacion() {
		...
		personaService.registrarCoordinacion(txtNombre.getText().trim(), txtEmail.getText().trim(),
				obtenerCodigoNacionalidad(), chkSenior.isSelected(), fechaSenior, txtUsuario.getText().trim(),
				cpPassword.getText());
