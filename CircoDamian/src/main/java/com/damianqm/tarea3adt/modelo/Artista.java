...
public class Artista extends Persona {
	...
	@CollectionTable(name = "artista_especialidad", joinColumns = @JoinColumn(name = "id_artista"), uniqueConstraints = @UniqueConstraint(name = "uk_artista_especialidad", columnNames = {
			"id_artista", "especialidad" }))
	...
	public Artista(String nombre, String email, String nacionalidad, String apodo, Set<Especialidad> especialidades) {
