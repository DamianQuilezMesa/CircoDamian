...
/**
 * Componente personalizado para campos de contraseña. Tiene un PasswordField y
 * un TextField apilados en un StackPane (sincronizados), un botón para alternar
 * ver/ocultar y una etiqueta de validación en tiempo real.
 *
 * Reglas: no espacios y más de 2 caracteres.
 *
 * Uso en FXML: &lt;CampoPassword fx:id="cpPassword"/&gt;
 */
public class CampoPassword extends VBox {
	...
	private final Button btnMostrar = new Button("Ver/No ver");
