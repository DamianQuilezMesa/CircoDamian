...
/**
 * Gestiona el Stage principal y el cambio de escenas. Tamaño fijo, ventana no
 * redimensionable. Además conecta la tecla F1 a la ayuda del controlador
 * activo.
 */
public class StageManager {
	...
	/**
	 * Busca el método 'mostrarAyuda' del controlador y lo invoca. Usamos reflexión
	 * para no obligar a que todos implementen una interfaz común.
	 */
