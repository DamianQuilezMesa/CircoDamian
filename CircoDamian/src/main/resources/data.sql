-- ============================================================
-- data.sql - Datos de prueba  (circo_damianqm v2)
-- INSERT IGNORE: seguro para re-ejecuciones
-- ============================================================
...
(7,  'El Gran Finale',       20.0),
(8,  'Ilusiones',            10.5),
(9,  'Torre Humana',         14.0),
(10, 'Desaparicion Final',    8.0);

-- RELACIÓN ESPECTÁCULO ↔ NÚMERO (con orden)
